...
namespace SCIQUSTICKETS.BUSINESS.Implementations.Service
{
	...
	UserManager<ApplicationUser> userManager)
		...
		{
			// Create the Identity user first because Account.AccountId
			// is a foreign key to AspNetUsers.Id.
	...
	"Customer@123"
			...
			string autoGeneratedId =
				await _accountRepository.GenerateNextAccountIdAsync();

			var account = new Account
			{
				// IMPORTANT:
				// AccountId must match an existing AspNetUsers.Id.
			...
			var createdAccount =
				await _accountRepository.GetWithDetailsByIdAsync(account.AccountId);
