...
export default function Customers() {
  ...
  const handleAssignCustomPlan = async () => {
    ...
    try {
      ...
      setMessage({
        type: 'error',
        text: err.response?.data?.message || 'Failed to assign Custom Support Plan.'
      });
    }
  };
  ...
  const handleAssignEmployee = async () => {
    ...
    try {
      ...
      setMessage({
        type: 'error',
        text: err.response?.data?.message || 'Failed to assign employee.'
      });
    }
  };
  ...
  const handleRemoveEmployee = async (id) => {
    try {
      ...
      setDedicatedEmployees(
        dedicatedEmployees.filter(e => e.accountDedicatedEmployeeId !== id)
      );
      ...
      setMessage({
        type: 'error',
        text: err.response?.data?.message || 'Failed to remove employee.'
      });
    }
  };
  ...
  const handleAddCustomer = async (e) => {
    ...
    try {
      ...
      setMessage({
        type: 'error',
        text: err.response?.data?.message || 'Failed to create customer company.'
      });
    }
  };
    ...
    <div className="tickets-page">
      ...
      >
        <div>
          <h1>
            ...
            />{' '}
            Customer Companies CRM
          </h1>

          <p>
            {userIsAdmin &&
              'Full Admin Access: Manage all customer companies, multi-contact addresses, and assigned support plans.'}
            {userIsDeptHead &&
              'Department Head View: Inspect customer companies subscribed to your department services.'}
            {userIsEmp &&
              'Employee View: Scoped to customer companies with currently active tickets.'}
          </p>
        </div>
          ...
          {filtered.map((c, i) => (
            ...
            >
              ...
              >
                ...
                >
                  {c.accountName || c.name || 'Company Account'}
                </h3>
              ...
              >
                ...
                >
                  <Mail size={14} />
                  <span>{c.email || 'customer@company.com'}</span>
                </div>
                ...
                >
                  <MapPin size={14} />
                  <span>HQ Office: San Francisco, CA</span>
                </div>
              </div>
      ...
      {showConfigModal && selectedCustomer && (
        ...
        >
          ...
          >
            <h2 style={{ color: 'white', marginTop: 0 }}>
              Manage: {selectedCustomer.accountName}
            </h2>
            ...
            >
              Configure Support Plans and assign Dedicated Employees.
            </p>
            ...
            <div style={{ marginBottom: '2rem' }}>
              ...
              {currentPlan ? (
                ...
                >
                  No active support plan assigned.
                </div>
              )}
              ...
              {planMode === 'preset' ? (
                <div style={{ display: 'flex', gap: '10px' }}>
                  ...
                  >
                    ...
                    >
                      Select plan (Basic, Silver, Gold, Platinum)...
                    </option>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        onChange={e =>
                          setCustomPlan({
                            ...customPlan,
                            includesWeekendSupport: e.target.checked
                          })
                        }
                      />
                      Weekend Support
                    ...
                    >
                      <input
                        ...
                        onChange={e =>
                          setCustomPlan({
                            ...customPlan,
                            blockWhenExhausted: e.target.checked
                          })
                        }
                      />
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={customPlan.emailNotificationsEnabled}
                        onChange={e =>
                          setCustomPlan({
                            ...customPlan,
                  ...
                  <button
                    className="btn btn--primary"
                    onClick={handleAssignCustomPlan}
                    style={{
                      background:
                  ...
                  {dedicatedEmployees.length > 0 ? (
                    ...
                    >
                      {dedicatedEmployees.map(emp => (
                        <div
                          key={emp.accountDedicatedEmployeeId}
                          style={{
                            display: 'flex',
                            justifyContent: 'space-between',
                            alignItems: 'center',
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleRemoveEmployee(
                                emp.accountDedicatedEmployeeId
                              )
                            }
                          >
                    ...
                    isTierAllowed && (
                      ...
                      >
                        No dedicated employees assigned.
                      </div>
                    )
                  )}
                  ...
                  {isTierAllowed && (
                    <div style={{ display: 'flex', gap: '10px' }}>
                      ...
                      >
                        ...
                        >
                          {isLimitReached
                            ? `Tier limit reached (${maxAllowed} max allowed)`
                            : 'Select an employee to assign as dedicated agent...'}
                        </option>

                        {availableEmployees
                          .filter(
                            e =>
                              !dedicatedEmployees.some(
                                de => de.employeeUserId === e.id
                              )
                          )
                          .map(e => (
                            <option
                      ...
                      <button
                        ...
                        disabled={
                          !selectedEmployeeId || isLimitReached
                        }
                        style={{
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Account and support plan details
                </p>
              </div>
              ...
              >
                ...
                <div>
                  <Phone
                    ...
                    style={{ marginRight: '8px' }}
                  />
                  {drawerCustomer.registeredMobileNumber ||
